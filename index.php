...
<body class="bg-black text-white selection:bg-emerald-500">
    ...
    <footer id="contact" class="py-12 sm:py-16 md:py-24 bg-black border-t border-white/10 px-4 sm:px-6">
        <div class="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8 md:gap-12 text-left">
            ...
            <div class="flex flex-col items-start">
                ...
                <a href="#home" class="bg-zinc-900 border border-white/10 p-2 sm:p-3 rounded-lg sm:rounded-xl hover:bg-emerald-600 transition-all">
