                            ...
                            <?php foreach ($available_plans as $plan): ?>
                                <div class="bg-white/5 p-6 rounded-[2rem] border border-white/10 flex flex-col group hover:bg-white/[0.07] transition-all duration-500 shadow-xl">
                                    <div class="px-2">
                                        ...
                                        <?php if ($user['status'] === 'approved'): ?>
                                            <a href="../preview.php?id=<?php echo $plan['id']; ?>" class="inline-flex w-full items-center justify-center gap-3 bg-emerald-600 text-white py-5 rounded-2xl text-[11px] font-black uppercase tracking-[0.2em] hover:bg-emerald-500 hover:shadow-[0_0_30px_rgba(16,185,129,0.3)] transition-all active:scale-95 mb-6">
                                        ...
                                        <?php else: ?>
                                            <div class="text-center py-5 bg-white/5 rounded-2xl text-[10px] font-bold uppercase tracking-widest text-zinc-600 border border-dashed border-white/10 mb-6">Awaiting Approval...</div>
                                        <?php endif; ?>
