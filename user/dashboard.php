                    ...
                    <?php if ($user['status'] === 'approved'): ?>
                        <div class="grid sm:grid-cols-2 gap-6">
                            <?php foreach ($available_plans as $plan): ?>
                                <div class="bg-white/5 p-6 rounded-[2rem] border border-white/10 flex flex-col group">
                                    <div class="aspect-square rounded-2xl overflow-hidden border border-white/10 mb-4">
                                        <?php if (!empty($plan['preview_image'])): ?>
                                            <img src="../<?php echo $plan['preview_image']; ?>" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500">
                                        <?php else: ?>
                                    ...
                                    <?php else: ?>
                                        <div class="mt-auto text-center py-4 text-zinc-500 text-[10px] font-bold uppercase tracking-widest">Awaiting PDF...</div>
                                    <?php endif; ?>
                                </div>
                            <?php endforeach; ?>
                        </div>
