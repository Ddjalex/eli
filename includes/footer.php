    ...
    <div class="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8 md:gap-12 text-left">
        ...
        <div>
            ...
            <div class="space-y-4 sm:space-y-6">
                <?php
                function getFooterSetting($pdo, $key, $default) {
                    try {
                ...
                <div class="flex items-start gap-3 sm:gap-4">
                    ...
                    <p class="text-zinc-400 text-xs sm:text-sm leading-relaxed">
                        <?php echo getFooterSetting($pdo, 'footer_address', 'Addis Ababa, Ethiopia'); ?>
                    </p>
                </div>
                <div class="flex items-center gap-3 sm:gap-4">
                    <span class="text-emerald-500 text-lg sm:text-xl flex-shrink-0">📱</span>
                    <p class="text-zinc-400 text-xs sm:text-sm font-bold">
                        <?php echo getFooterSetting($pdo, 'contact_phone', '+251 911 000 000'); ?>
                    </p>
                </div>
                <div class="flex items-center gap-3 sm:gap-4">
                    <span class="text-emerald-500 text-lg sm:text-xl flex-shrink-0">✉️</span>
                    <p class="text-zinc-400 text-xs sm:text-sm">
                        <?php echo getFooterSetting($pdo, 'footer_email', 'info@elenimekuria.com'); ?>
                    </p>
                </div>
            </div>
        </div>
        ...
        <div>
            ...
            <ul class="space-y-2 sm:space-y-4 text-sm">
                <li><a href="<?php echo getFooterSetting($pdo, 'footer_tiktok', '#'); ?>" class="text-zinc-400 hover:text-emerald-500 transition-all flex items-center gap-2 sm:gap-3 uppercase tracking-widest font-bold text-[8px] sm:text-[10px]">
                ...
                <li><a href="<?php echo getFooterSetting($pdo, 'contact_social_ig', '#'); ?>" class="text-zinc-400 hover:text-emerald-500 transition-all flex items-center gap-2 sm:gap-3 uppercase tracking-widest font-bold text-[8px] sm:text-[10px]">
                ...
                <li><a href="<?php echo getFooterSetting($pdo, 'contact_whatsapp_link', '#'); ?>" class="text-zinc-400 hover:text-emerald-500 transition-all flex items-center gap-2 sm:gap-3 uppercase tracking-widest font-bold text-[8px] sm:text-[10px]">
                ...
                <li><a href="<?php echo getFooterSetting($pdo, 'footer_telegram', '#'); ?>" class="text-zinc-400 hover:text-emerald-500 transition-all flex items-center gap-2 sm:gap-3 uppercase tracking-widest font-bold text-[8px] sm:text-[10px]">
