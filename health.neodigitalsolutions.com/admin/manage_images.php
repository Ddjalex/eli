...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $image_keys = ['hero_bg_image', 'about_image', 'login_bg_image', 'register_bg_image', 'user_dashboard_bg', 'certificate_image'];
        ...
        <main class="flex-1 p-8 lg:p-12">
            ...
            <div class="space-y-8">
                ...
                <div class="grid md:grid-cols-2 gap-8">
                    <form action="manage_images.php" method="POST" enctype="multipart/form-data" class="glass p-8 rounded-3xl">
                        ...
                        <?php endif; ?>
                        <input type="file" name="user_dashboard_bg" onchange="this.form.submit()" class="w-full bg-black/50 border border-white/10 p-3 rounded-xl text-sm">
                    </form>
                    ...
                    <form action="manage_images.php" method="POST" enctype="multipart/form-data" class="glass p-8 rounded-3xl">
                        ...
                        <?php endif; ?>
                        <input type="file" name="login_bg_image" onchange="this.form.submit()" class="w-full bg-black/50 border border-white/10 p-3 rounded-xl text-sm">
                    </form>
                    ...
                    <form action="manage_images.php" method="POST" enctype="multipart/form-data" class="glass p-8 rounded-3xl">
                        ...
                        <?php endif; ?>
                        <input type="file" name="register_bg_image" onchange="this.form.submit()" class="w-full bg-black/50 border border-white/10 p-3 rounded-xl text-sm">
                    </form>

                    <div class="glass p-8 rounded-3xl">
                        <label class="block text-sm font-bold uppercase tracking-widest text-zinc-500 mb-4">About Section Slide</label>
                        <form action="manage_images.php" method="POST" enctype="multipart/form-data">
                            <input type="file" name="about_image" onchange="this.form.submit()" class="w-full bg-black/50 border border-white/10 p-3 rounded-xl text-sm">
                        </form>
                        <div class="grid grid-cols-4 gap-2 mt-4">
                            ...
                            foreach ($about_slides as $slide): ?>
                                <div class="relative group">
                                    <img src="../<?php echo $slide['image_url']; ?>" class="w-full h-16 object-cover rounded-lg">
                                    <form method="POST" class="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 flex items-center justify-center text-red-500 rounded-lg transition-all" onsubmit="return confirm('Delete?')">
                                        <input type="hidden" name="slide_id" value="<?php echo $slide['id']; ?>">
                                        <input type="hidden" name="delete_about_slide" value="1">
                                        <button type="submit">
                ...
                <!-- Text Settings Form -->
                <form action="manage_images.php" method="POST" class="space-y-8">
                    <div class="grid md:grid-cols-2 gap-8">
                        <?php
                        $text_settings = [
                    ...
                    <div class="flex justify-end">
                        <button type="submit" name="save_text_settings" value="1" class="bg-emerald-600 text-white px-12 py-4 rounded-2xl font-bold uppercase tracking-widest hover:bg-emerald-500 transition-all shadow-xl shadow-emerald-900/20">
                            Save Text Changes
                        </button>
                    </div>
                </form>
