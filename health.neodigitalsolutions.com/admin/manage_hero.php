    ...
    <div class="flex min-h-screen">
        ...
        <aside class="w-64 border-r border-white/5 bg-[#09090b] p-6 hidden lg:block">
            ...
            <nav class="space-y-2">
                ...
                <a href="manage_hero.php" class="flex items-center gap-3 px-4 py-3 rounded-xl bg-emerald-500/10 text-emerald-500 border border-emerald-500/20 font-medium">Hero Slider</a>
